...
import {verifyAdmin, verifyUser, verifyToken, verifyRoleBartender, verifyRoleWaitress} from "../utils/verifyToken.js";

const router= express.Router();

//routing for crud operation of bar order
router.post('/:tableid', verifyRoleWaitress, createBarOrder); //RUOLO CAMERIERE
